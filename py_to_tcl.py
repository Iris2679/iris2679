...
# To check what residues are in each community at each timestamp
# ex. check community C5 at timestamp 4 (user3)
# set sel [atomselect top "user3 5"]
# puts [$sel get residue]
